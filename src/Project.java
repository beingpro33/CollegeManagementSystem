...
public class Project extends JFrame implements ActionListener {
    ...
    Project() {
        ...
        /* Frame Image */
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/third_new.png"));
        main = i1.getImage().getScaledInstance(1600, 800, Image.SCALE_DEFAULT);
        ...
        setTitle("Vellore Institute of Technology, Chennai");
        setVisible(true);
        setResizable(false);
