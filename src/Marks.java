...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String rollno) {
        ...
        JLabel heading = new JLabel("Vellore Institute of Technology, Chennai");
        ...
        try {
            jdbc db = new jdbc();
            ResultSet rs = db.stm.executeQuery("select * from marks_details where roll_no = '" + rollno + "'");
            while (rs.next()) {
                cSemester.add(rs.getString("semester_or_year"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
         ...
         * 
         * String query1 =
         * "select * from subject where roll_no = '"+rollno+"' and semester = '"
         * +cSemester.getSelectedItem()+"'" ;
         * 
         * String query2 =
         * "select * from marks_Details where roll_no = '"+rollno+"' and semester = '"
         * +cSemester.getSelectedItem()+"'";
         * 
         ...
         * jdbc db = new jdbc();
         * 
         * ResultSet rs1 = db.stm.executeQuery("select * from subject where roll_no = '"
         ...
         * 
         * /* ResultSet rs2 =
         * db.stm.executeQuery("select * from marks_Details where roll_no = '"
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == Show) {
            ...
            try {
                ...
                String query1 = "select * from subject where roll_no = '" + rollno + "' and semester_or_year = '"
                        + cSemester.getSelectedItem() + "'";

                String query2 = "select * from marks_Details where roll_no = '" + rollno + "' and semester_or_year = '"
                        + cSemester.getSelectedItem() + "'";
                ...
                while (rs2.next()) {
                    sub1.setText(sub1.getText() + "------------" + rs2.getString("marks1"));
                    total = total + Integer.parseInt(rs2.getString("marks1"));
                    sub2.setText(sub2.getText() + "------------" + rs2.getString("marks2"));
                    total = total + Integer.parseInt(rs2.getString("marks2"));
                    sub3.setText(sub3.getText() + "------------" + rs2.getString("marks3"));
                    total = total + Integer.parseInt(rs2.getString("marks3"));
                    sub4.setText(sub4.getText() + "------------" + rs2.getString("marks4"));
                    total = total + Integer.parseInt(rs2.getString("marks4"));
                    sub5.setText(sub5.getText() + "------------" + rs2.getString("marks5"));
                    total = total + Integer.parseInt(rs2.getString("marks5"));
